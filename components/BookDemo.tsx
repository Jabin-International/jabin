      ...
      <DialogContent className="sm:max-w-lg max-w-[95vw] mx-auto max-h-[95vh] overflow-y-auto p-4 sm:p-6">
        ...
        {isSubmitted ? (
          <div className="text-center py-6 sm:py-8">
            ...
            <h3 className="text-base sm:text-lg font-semibold text-green-800 mb-2">Consultation Booked Successfully!</h3>
            <p className="text-sm sm:text-base text-green-600">We&apos;ll contact you within 24 hours to schedule your free consultation session.</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            ...
            <div>
              <Label htmlFor="organization" className="text-sm font-medium">Business/Organization *</Label>
              <Input
                id="organization"
                name="organization"
            ...
            <div>
              <Label htmlFor="program" className="text-sm font-medium">Service of Interest</Label>
              <Select value={formData.program} onValueChange={(value) => handleSelectChange('program', value)}>
                <SelectTrigger className="mt-1">
                  <SelectValue placeholder="Select a service" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="web-solutions">Jabin Web Solutions</SelectItem>
                  <SelectItem value="store-products">Jabin Store Products</SelectItem>
