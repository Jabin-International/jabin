        ...
        <div className="block lg:hidden space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Comprehensive business solutions including custom web development, creative products, expert consultancy, and technology training.
            </p>
          ...
          {/* Quick Links & Legal Policies - 2 columns on mobile */}
            ...
            <div className="space-y-4 text-sm">
              <div className="flex items-start space-x-3 text-gray-300">
                ...
                <div className="leading-relaxed flex-1">
                  <div>32A Yashoda Nagar Chauraha</div>
                  <div>Fzd Road Chinhat, Malhaur</div>
                  <div>Lucknow, UP – 226028, India</div>
                </div>
              </div>
              <div className="flex items-center space-x-3 text-gray-300">
                <i className="fas fa-phone w-4 h-4 flex-shrink-0"></i>
                <span className="break-all">+91 7523944939</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-300">
                <i className="fas fa-envelope w-4 h-4 flex-shrink-0"></i>
                <span className="break-all">info@jabin.org</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 text-center md:text-left">
            <div className="text-gray-400 text-xs md:text-sm">
              © {currentYear} Jabin International Private Limited. All rights reserved. | CIN: U63122UP2024PTC202046
            </div>
