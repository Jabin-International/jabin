      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Our commitment to excellence in business solutions is reflected in these meaningful outcomes
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <p className="text-gray-500 text-sm">
            Trusted by businesses nationwide • Quality assured services • Customer satisfaction guaranteed
          </p>
        </div>
      </div>
    </section>
